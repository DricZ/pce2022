...
if (isset($_GET['stat'])) {
    if ($_GET['stat'] == 1) {
        echo "<script>alert('Silakan periksa Kode Peserta dan Password Anda kembali.');</script>";
    } else if ($_GET['stat'] == 2) {
        echo "<script>alert('Silakan periksa kembali captcha Anda.');</script>";
    } else if ($_GET['stat'] == 4) {
        echo "<script>alert('Format Kode Peserta Anda tidak sesuai.');</script>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    ?>
        <div class="wrapper">
            <div class="container justify-content-center text-center" id="header">
                <h1 class="font-weight-bold" style="text-align: center;">BRIDGE COMPETITION</h1>
            ...
            <div class="container d-flex justify-content-center ">
                <div class="jumbotron my-auto" id="form">
                    <form class="animateBox" action="phps/loginattempt.php" method="post">
                        <input type="text" style="margin-top: 15px;" class="form-control" name="username" placeholder="Kode Peserta">
            ...
            <div class="container justify-content-center text-center" id="header">
                <a href="../" class="font-weight-small" style="text-decoration: none; text-align: center; font-size: 12pt; color: yellow;">BACK TO THE MAIN WEBSITE</a>
