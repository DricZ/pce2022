...
if (isset($_GET['stat'])) {
    if ($_GET['stat'] == 1) {
        echo "<script>alert('Gak boleh curang, ya.');</script>";
    }
}
?>
<style>
                ...
                onOpen: function() {
                    setTimeout(() => {
                        ...
                        <div style="color: black; text-align: center;">
                            <h5>ROUND #1 - <b><?= strtoupper($_GET['ans1']) ?> <?php if ($_GET['ans1'] == 'true') {
                                                                                    echo '<i class="fas fa-check" style="color: green"></i>';
                                                                                } else {
                                                                                    echo '<i class="fas fa-times" style="color: red;"></i>';
                                                                                } ?></b></h5>
                            <h5>ROUND #2 - <b><?= strtoupper($_GET['ans2']) ?>  <?php if ($_GET['ans2'] == 'true') {
                                                                                    echo '<i class="fas fa-check" style="color: green"></i>';
                                                                                } else {
                                                                                    echo '<i class="fas fa-times" style="color: red;"></i>';
                                                                                } ?></b></h5>
                            <h5>ROUND #3 - <b><?= strtoupper($_GET['ans3']) ?>  <?php if ($_GET['ans3'] == 'true') {
                                                                                    echo '<i class="fas fa-check" style="color: green"></i>';
                                                                                } else {
                                                                                    echo '<i class="fas fa-times" style="color: red;"></i>';
                                                                                } ?></b></h5>
                            <h5>ROUND #4 - <b><?= strtoupper($_GET['ans4']) ?>  <?php if ($_GET['ans4'] == 'true') {
                                                                                    echo '<i class="fas fa-check" style="color: green"></i>';
                                                                                } else {
                                                                                    echo '<i class="fas fa-times" style="color: red;"></i>';
                                                                                } ?></b></h5>
                            <h5>ROUND #5 - <b><?= strtoupper($_GET['ans5']) ?>  <?php if ($_GET['ans5'] == 'true') {
                                                                                    echo '<i class="fas fa-check" style="color: green"></i>';
                                                                                } else {
                                                                                    echo '<i class="fas fa-times" style="color: red;"></i>';
                                                                                } ?></b></h5>
        <br>                                                                              <h5>You Bet:</h5>                                                                              <h5 style="color: red;"><b><?= $_GET['bet'] ?> Bridge Money</b></h5>
        <br>                                                                              <h5>You Get:</h5>
                        `;
                        ...
                        if ($countTrue == 5) {
                            $bonusMoney = 3 * $_GET['bet'];
                        }
                        if ($countTrue == 4) {
                            $bonusMoney = 2 * $_GET['bet'];
                        }
                        if ($countTrue == 3) {
                            $bonusMoney = 1.25 * $_GET['bet'];
                        }
                        if ($countTrue == 2) {
                            $bonusMoney = 0.5 * $_GET['bet'];
                        }
                        if ($countTrue == 1 || $countTrue == 0) {
                            $bonusMoney = 0 * $_GET['bet'];
                        }
                        ?>

                        str += `
                        <h5 style="color: green;"><b><?= $bonusMoney ?> Bridge Money</b></h5>
                        <br>
                        <h5>Stay tuned for <b>another round</b>!</h5>
                            </div>
                        `;
    ...
    <div class="row-cols-1">
        ...
        ?>
            ...
            if ($timestamp >= $timestamp1 && $timestamp < $timestamp1End) {
                $hiddenPost = true;
            ?>
                <!-- Mulai Tampilan untuk satu hidden post -->
                ...
                <!-- Akhir dari Tampilan untuk satu hidden post -->
            <?php
            }
            ...
            ?>
                <div id="no-content-msg-info">
                    <img src="assets/image/nothing-to-say.svg" width="40%">
                    <h3>Stay tuned for the upcoming Hidden Post!</h3>
                </div>
        <?php
            }
        }
