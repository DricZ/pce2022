    ...
    <nav class="navbar fixed-bottom justify-content-center" role="navigation">
        ...
        <ul>
            <a class="nav-link active" id="menu" href="shop.php">
                <li><img class="icon-navBar" src="assets/Design Web/pasar.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Shop</li>
            </a>
        </ul>
        <ul>
            <a class="nav-link active" id="menu" href="craft.php">
                <li><img class="icon-navBar" src="assets/Design Web/crafting-01.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Craft</li>
            </a>
        </ul>
        <ul>
            <a class="nav-link active" id="menu" href="info.php">
                <li><img class="icon-navBar" src="assets/Design Web/info.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Info</li>
            </a>
        </ul>
        <ul>
            ...
            ?>
                ...
                ?>
                    ...
                    ?>
                    <li><img class="icon-navBar" src="assets/Design Web/Map-01.png" alt="" style="margin-bottom: 5px;">
                        </svg></li>
                    <li>Map</li>
                    </a>
        </ul>
        <ul>
            <a class="nav-link active" id="menu" href="skill.php">
                <li><img class="icon-navBar" src="assets/Design Web/treasure-01.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Skill</li>
            </a>
        </ul>
        <ul>
            <a class="nav-link active" id="menu" href="inventory.php">
                <li><img class="icon-navBar" src="assets/Design Web/tas.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Inventory</li>
            </a>
        </ul>
        ...
        <ul>
            <a class="nav-link active" id="menu" href="achievements.php">
                <li><img class="icon-navBar" src="assets/Design Web/achievement.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Achievements</li>
            </a>
        </ul>
        ...
        <ul>
            <a class="nav-link active" id="menu" href="minigames.php">
                <li><img class="icon-navBar" src="assets/Design Web/mini games-01.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Mini Games</li>
            </a>
        </ul>
        ...
        <ul>
            ...
            <a class="nav-link active exit" id="menu" href="phps/signout.php">
                <li><img class="icon-navBar" src="assets/Design Web/log out-01.png" alt="" style="margin-bottom: 5px;">
                    </svg></li>
                <li>Sign Out</li>
            </a>
        </ul>
