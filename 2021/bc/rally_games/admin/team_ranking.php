...
<head>
    <title>Admin BC 2021 - Team Ranking</title>
</head>
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                var table = $('#historyTable').DataTable({
                    "oLanguage": {
                        "sEmptyTable": "There Are No Teams"
                    }
                });
                Search(table);
            },
...
<body>
    <div class="container-fluid" style="margin-top: 30px;">
        <div class="title-row row mx-4">
            <h1 class="title"><i class="fas fa-trophy"></i> TEAM RANKING</h1>
        </div>
        <div class="row">
