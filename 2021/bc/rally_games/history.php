                            ...
                            <div class="card-body p-2">
                                <div class="row col-12">
                                    ...
                                    <div class="col-4 pt-3 text-right">
                                        <h4><img src="assets/image/bridge dollar.png" width="20%" style="border-radius:0;margin-top:-4px;">` + formatNumber(d.money_value) + `</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
