            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 100px;">
                <g class="" transform="translate(0,0)" style="">
                    <path
                        ...
                        fill="rgb(32,31,31)" transform="rotate(-30) translate(-190 100)" fill-opacity="1"></path>
                </g>
            </svg>
        </div>
        <h1 id="title">INFO</h1>
    ...
    <div class="card-columns">
        ...
        <!-- <div class="card news-card news-3" id="info-card">
            <div class="card-body">
                ...
                <p class="card-text">Jakarta menjadi salah satu kota yang sangat terdampak akibat pandemi ini. Jakarta
                    mengambil keputusan untuk lockdown, menjadikan warga Jakarta tidak bisa keluar dan warga luar
                    Jakarta tidak bisa masuk ke Jakarta. Bali menghiraukan arahan pemerintah dengan melanggar protokol
                    kesehatan yang diterapkan. Menjadikan para pekerja di Bali banyak terinfeksi COVID-19 sehingga harga
                    pekerja naik 30%. Harga bahan bangunan juga terdampak dengan harga sebagai berikut; harga pasir
                    mengalami peningkatan sebesar 15%, harga semen mengalami peningkatan sebesar 10%, sementara harga
                    lainnya tetap. Lain halnya dengan Bali, Jayapura sangat menaati protokol kesehatan yang menyebabkan
                    penyebaran virus COVID-19 dapat diminimalisir, sehingga pembangunan dapat tetap berjalan. Harga
                    seluruh bahan bangunan mengalami penurunan sebesar 5% lebih murah. Ditengah pandemi yang masih
                    berlangsung, cuaca buruk sering kali terjadi. Hujan deras yang mengguyur kota Lampung menyebabkan
                    jalan-jalan di kota Lampung yang biasanya dilalui oleh mobil pengangkut bahan bangunan menjadi
                    licin, sehingga menyusahkan mobilisasi bahan bangunan. Harga setiap bahan bangunan di kota Lampung
                    meningkat 10% dikarenakan adanya biaya transportasi tambahan.
                </p>
                <p class="card-text"><small
                        class="text-muted"><?= intval((strtotime($timestamp) - strtotime('14:15')) / 60) ?> mins
                        ago</small></p>
            </div>
        </div> -->
        <!-- Akhir dari Tampilan untuk satu info -->
        ...
        <!-- <div class="card news-card news-2" id="info-card">
            <div class="card-body">
                ...
                <p class="card-text">Terjadinya pandemi virus corona! Seluruh harga bahan bangunan serta harga pekerja
                    menjadi meningkat 20% lebih mahal.
                </p>
                <p class="card-text"><small
                        class="text-muted"><?= intval((strtotime($timestamp) - strtotime('13:55')) / 60) ?> mins
                        ago</small></p>
            </div>
        </div> -->
        <!-- Akhir dari Tampilan untuk satu info -->
        ...
        <!-- <div class="card news-card news-1" id="info-card">
            <div class="card-body">
                ...
                <p class="card-text">Terjadi kebakaran hutan di Kalimantan! Membuat harga kayu di Banjarmasin meningkat
                    40% dan harga pekerja meningkat 15% lebih mahal dari harga semula. Disisi lain, Bali mengalami
                    peningkatan jumlah turis yang datang dari mancanegara. Membuat pembangunan di Bali berkembang pesat.
                    Harga kayu, baja, semen, dan pasir mengalami penurunan sebanyak 10% dari harga semula. Namun harga
                    pekerja meningkat menjadi 10% lebih mahal. Sementara itu, di Yogyakarta terjadi gempa bumi yang
                    menjadikan seluruh harga bahan bangunan meningkat 15% lebih mahal.
                </p>
                <p class="card-text"><small
                        class="text-muted"><?= intval((strtotime($timestamp) - strtotime('13:35')) / 60) ?> mins
                        ago</small></p>
            </div>
        </div> -->
        <!-- Akhir dari Tampilan untuk satu info -->
        ...
        <!-- <div class="card news-card" id="info-card">
            <div class="card-body">
                ...
                <p class="card-text">
                    Berikut kami lampirkan Penjelasan Rally Games secara keseluruhan. Tim dapat membacanya <a
                        href='assets/Rally Games Bridge Competition - Petra Civil Expo 2021.pdf'>di sini</a>. Jika ada
                    hal yang tidak dimengerti mengenai Mini Games dapat ditanyakan di pos breakout room masing-masing.
                    Jika ada hal yang tidak dimengerti mengenai game besar dapat join ke ZOOM utama kembali dengan link:
                    <a href='http://petra.id/RallyBCWorkshopSMA' target="_blank">petra.id/RallyBCWorkshopSMA</a>
                </p>
                <p class="card-text">
