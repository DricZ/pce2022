...
<footer id="contactus" class="contain mt-5 py-4 px-5" style="z-index:2000; background-image:url('../assets/image/bg_footer.jpg'); background-size:cover;">
    <div class="row row-cols-md-3 row-cols-1">
        <div class="col text-center mt-4">
            ...
            <p class="mt-2" style="color:white; text-align: center; font-size: 12pt;">
                <b>Petra Civil Expo</b> is the biggest competition event held by the Petra Christian University Civil Engineering Student Association. <b>Petra Civil Expo</b> is home to <b>three national competitions</b> which are usually held every year, namely <b>Bridge Competition</b>, <b>Earthquake Resistant Design Competition</b>, and <b>Concrete Pressing Strength Competition</b>. For <b>Petra Civil Expo 2021</b>, apart from hosting the three competitions, there will also be an <b>International Webinar</b>.<br><br><a href="https://www.petra.ac.id/" target="_blank"><img src="..\assets\logo_light.png" alt="UK PETRA" style="width: 35%; position:relative;" id="logo"></a>&nbsp;<a href="https://www.petra.ac.id/" target="_blank"><img src="..\assets\60ukp.png" alt="60" style="width: 17%; position:relative;" id="logo"></a><br><br><a target="_blank" style="text-decoration: none; color: white;" href="http://informatika.petra.ac.id/" id="itdiv">&copy; IT Division Petra Civil Expo 2021</a>
            </p>
        </div>
        ...
        <div class="col mt-4 mb-5">
            ...
            <div class="menu row">
                <div class="col-12 mt-3"><a class="yess" href="../" style="text-decoration: none;">Home</a></div>
