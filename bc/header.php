            ...
            <div class="menu">
                <ul>
                    ...
                    ?>
                            ...
                            <!-- <li><a href="webinar_register.php" style="color: white;">International Webinar</a></li> -->
                            <li><a href="#contactus" style="color: white;">Contact Us</a></li>
                            <li><a href="bc/index.php" style="color: white;">Bridge Competition</a></li>
                            <!-- <li><a href="form_daftar.php" style="color: white;" class="register"><i class="far fa-edit"></i> <b>Register Here</b></a></li> -->
                        <?php
                        } else if ($_SESSION['page'] == 'pengiriman_balsa' || $_SESSION['page'] == 'jadwal_checking') {
                        ?>
                            ...
                            <!-- <li><a href="form_daftar.php" style="color: black;" class="register"><i class="far fa-edit"></i> <b>Register Here</b></a></li> -->
                    <?php
                        }
                    }
                    ?>
