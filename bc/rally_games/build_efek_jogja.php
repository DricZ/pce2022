...
<script>
    ...
    function getBuilding() {
        ...
        $.ajax({
            url: "phps/build_jogjaGetBuilding.php",
            method: "POST",
            data: {
                idkel: idkel,
                idkota: idkota
    ...
    $(document).on('change', '.form-check-input', function() {
        $('.jml-bhn').each(function() {
            $(this).html(' ' + $(this).data("val"));
        });
        var id = $(this).attr('id');

        if ($("#" + id + "").is(":checked")) {
            var val = $(this).closest('.form-check').find('.jml-bhn').text();
            var value = parseInt(val);
            value--;
            $(this).closest('.form-check').find('.jml-bhn').html(" " + value);
        }
    });
    ...
    $(function() {
        $(document).on('click', '.btn-beli', function() {
            ...
            var cukup = true;
            var idkota = <?= $rowTeam['location_now_id_city']; ?>;
            var dikurangi = $('input[name="' + building + '"]:checked').val();
            var id_dikurangi = $('input[name="' + building + '"]:checked').attr('id');
            var kerja = 0;
            var pekerja_lampung = false;
            // alert(dikurangi)
            if (building == 'Jembatan Kayu') {
                if (dikurangi == 'kayu') {
                    jml_bhn = '3 Kayu dan 1 Pekerja';
                    if (kayu < 3 || pekerja < 1) {
                        cukup = false;
                    }
                ...
                if (dikurangi == 'baja') {
                    jml_bhn = '2 Baja, 1 Semen, dan 2 Pekerja';
                    if (baja < 2 || semen < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'semen') {
                    jml_bhn = '3 Baja dan 2 Pekerja';
                    if (baja < 3 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pekerja') {
                    jml_bhn = '3 Baja, 1 Semen, dan 1 Pekerja';
                    if (baja < 3 || semen < 1 || pekerja < 1) {
                        cukup = false;
                    }
                    kerja = 1;
                }
                ...
                if (dikurangi == 'baja') {
                    jml_bhn = '3 Semen, 1 Pasir, dan 2 Pekerja';
                    if (semen < 3 || pasir < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'semen') {
                    jml_bhn = '1 Baja, 2 Semen, 1 Pasir, dan 2 Pekerja';
                    if (baja < 1 || semen < 2 || pasir < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pasir') {
                    jml_bhn = '1 Baja, 3 Semen, dan 2 Pekerja';
                    if (baja < 1 || semen < 3 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pekerja') {
                    jml_bhn = '1 Baja, 3 Semen, 1 Pasir, dan 1 Pekerja';
                    if (baja < 1 || semen < 3 || pasir < 1 || pekerja < 1) {
                        cukup = false;
                    }
                    kerja = 1;
                }
                ...
                if (dikurangi == 'baja') {
                    jml_bhn = '1 Semen, 2 Pasir, dan 2 Pekerja';
                    if (semen < 1 || pasir < 2 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'semen') {
                    jml_bhn = '1 Baja, 2 Pasir, dan 2 Pekerja';
                    if (baja < 1 || pasir < 2 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pasir') {
                    jml_bhn = '1 Baja, 1 Semen, 1 Pasir, dan 2 Pekerja';
                    if (baja < 1 || semen < 1 || pasir < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pekerja') {
                    jml_bhn = '1 Baja, 1 Semen, 2 Pasir, dan 1 Pekerja';
                    if (baja < 1 || semen < 1 || pasir < 2 || pekerja < 1) {
                        cukup = false;
                    }
                    kerja = 1;
                }
                ...
                if (dikurangi == 'baja') {
                    ...
                    jml_bhn = '2 Baja, 1 Pasir, dan 2 Pekerja';
                    if (baja < 2 || pasir < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pasir') {
                    ...
                    jml_bhn = '2 Baja, 1 Semen, 1 Pasir, dan 1 Pekerja';
                    if (baja < 2 || semen < 1 || pasir < 1 || pekerja < 1) {
                        cukup = false;
                    }
                    kerja = 1;
                }
                ...
                if (dikurangi == 'kayu') {
                    jml_bhn = '1 Kayu, 2 Pasir, dan 1 Pekerja';
                    if (kayu < 1 || pasir < 2 || pekerja < 1) {
                        cukup = false;
                    }
                } else if (dikurangi == 'pasir') {
                    jml_bhn = '2 Kayu, 1 Pasir, dan 1 Pekerja';
                    if (kayu < 2 || pasir < 1 || pekerja < 1) {
                        cukup = false;
                    }
                } else if (dikurangi == 'pekerja') {
                    jml_bhn = '2 Kayu dan 2 Pasir';
                    if (kayu < 2 || pasir < 2) {
                        cukup = false;
                    }
                }
                ...
                if (dikurangi == 'kayu') {
                    jml_bhn = '1 Kayu, 1 Semen, 1 Pasir, dan 1 Pekerja';
                    if (kayu < 1 || semen < 1 || pasir < 1 || pekerja < 1) {
                        cukup = false;
                    }
                } else if (dikurangi == 'semen') {
                    jml_bhn = '2 Kayu, 1 Pasir, dan 1 Pekerja';
                    ...
                    jml_bhn = '2 Kayu, 1 Semen, dan 1 Pekerja';
                    if (kayu < 2 || semen < 1 || pekerja < 1) {
                        cukup = false;
                    }
                } else if (dikurangi == 'pekerja') {
                    jml_bhn = '2 Kayu, 1 Semen, dan 1 Pasir';
                    if (kayu < 2 || semen < 1 || pasir < 1) {
                        cukup = false;
                    }
                }
            } else if (building == 'Apartemen') {
                if (dikurangi == 'kayu') {
                    jml_bhn = '1 Baja, 2 Semen, 2 Pasir, dan 2 Pekerja';
                    if (baja < 1 || semen < 2 || pasir < 2 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'baja') {
                    jml_bhn = '1 Kayu, 2 Semen, 2 Pasir, dan 2 Pekerja';
                    if (kayu < 1 || semen < 2 || pasir < 2 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'semen') {
                    jml_bhn = '1 Kayu, 1 Baja, 1 Semen, 2 Pasir, dan 2 Pekerja';
                    if (kayu < 1 || baja < 1 || semen < 1 || pasir < 2 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pasir') {
                    jml_bhn = '1 Kayu, 1 Baja, 2 Semen, 1 Pasir, dan 2 Pekerja';
                    if (kayu < 1 || baja < 1 || semen < 2 || pasir < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pekerja') {
                    jml_bhn = '1 Kayu, 1 Baja, 2 Semen, 2 Pasir, dan 1 Pekerja';
                    if (kayu < 1 || baja < 1 || semen < 2 || pasir < 2 || pekerja < 1) {
                        cukup = false;
                    }
                    kerja = 1;
                }
                ...
                if (dikurangi == 'kayu') {
                    ...
                    jml_bhn = '1 Kayu, 1 Baja, 1 Semen, 1 Pasir, dan 2 Pekerja';
                    if (kayu < 1 || baja < 1 || semen < 1 || pasir < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'semen') {
                    jml_bhn = '1 Kayu, 2 Baja, 1 Pasir, dan 2 Pekerja';
                    if (kayu < 1 || baja < 2 || pasir < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pasir') {
                    jml_bhn = '1 Kayu, 2 Baja, 1 Semen, dan 2 Pekerja';
                    if (kayu < 1 || baja < 2 || semen < 1 || pekerja < 2) {
                        cukup = false;
                    }
                    kerja = 2;
                } else if (dikurangi == 'pekerja') {
                    jml_bhn = '1 Kayu, 2 Baja, 1 Semen, 1 Pasir, dan 1 Pekerja';
                    if (kayu < 1 || baja < 2 || semen < 1 || pasir < 1 || pekerja < 1) {
                        cukup = false;
                    }
                    kerja = 1;
                }
            ...
            if (building != 'Taman' && building != 'Perumahan' && building != 'Jembatan Kayu') {
                <?php
                if ($efekLampung == true) { ?>
                    kerja = kerja - 1;
                    pekerja_lampung = true;
                    if (pekerja >= kerja) {
                        cukup = true;
                    }
                    else {
            ...
            // alert(jml_bhn);
            if (dikurangi != undefined) {
                if (cukup == true) {
                    if (pekerja_lampung == true) {
                        buildSwal.fire({
                            title: '<h3 style="color:white;">Konfirmasi Pembangunan</h3>',
                            html: '<d style="color:white;">Anda akan membangun <h5 class="pb-0 mb-0">' + building + '</h5> dengan menggunakan <h5 class="pb-0 mb-0">' + jml_bhn + '</h5><div class="container text-center efek-in-swal mt-4"><div class="row mt-1"><span class="badge badge-efek-lampung-in-swal p-2">Efek Lampung</span><small class="py-1 pl-2">Anda cukup menggunakan <b>' + kerja + ' Pekerja</b></small></div></div>',
                            icon: 'warning',
                ...
                buildSwal.fire({
                    title: '<h3 style="color:white;">Pembangunan Gagal!</h3>',
                    html: '<div style="color:white;">Pilih salah satu bahan bangunan untuk dikurangi 1!</div>',
                    icon: 'error'
                })
            }
