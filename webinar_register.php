...
<body>
    <section id="formdaftar" class="formdaftar">
        <div class="container">
            <center><a href="https://www.instagram.com/petracivilexpo/" target="_blank"><img
                        src="assets/pce_logo color.png" alt="" style="max-width: 50%;" id="logo-pce"></a></center>
            <br><br>
            ...
            <div class="justify-content-center mt-3 mx-3">
                ...
                <h5 class="title" style="text-align: center;">
                    <b><i class="fas fa-calendar-alt"></i> Saturday, March 5th, 2022</b>
                </h5>
                <h5 class="title" style="text-align: center;">
            ...
            <div class="justify-content-center mt-5 mx-3">
                ...
                <h4 class="title mt-3" style="text-align: center;">
                    <b>Riza Yosia Sunindijo ST MT MEng PhD MAIB ICIOB</b>
                </h4>
                <!-- <h4 class="title" style="text-align: center;">
            ...
            <form action="phps/daftar_webinar.php" method="post" enctype="multipart/form-data" onsubmit="pleaseWait()"
                id="form_daftar">
                <div class="col-sm-12 col-md-8 offset-md-2">
                    ...
                    <div class="row justify-content-center py-2 mx-3">
                        <h3 style="font-weight: bold; font-size: 14pt; color: red; text-align: center;">Please register
                            using a browser, not directly from LINE.</h3>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <h3 style="font-weight: bold; font-size: 18pt; color: red; text-align: center;">Where Are You
                            From?</h3>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="country" name="country"
                                    style="height:40px; font-size: 12pt;" required>
                                    <option value="">Please select one...</option>
                                    <option value="Indonesian Student">Indonesian Student</option>
                                    <option value="International Student">International Student (outside Indonesia)
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row" id="row_nama_sekolah">
                        <div class="col-12">
                            <div class="form-group">
                                <center><label for="nama_sekolah" id="label_nama_sekolah"
                                        style="font-weight: bold;">University or School Name</label></center>
                                <input type="text" class="form-control" placeholder="Petra Christian University"
                                    id="nama_sekolah" name="nama_sekolah"
                                    style="height:40px; font-size: 12pt; text-align: center;" required>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="row_alamat_sekolah">
                        <div class="col-12">
                            <div class="form-group">
                                <center><label for="alamat_sekolah" id="label_alamat_sekolah"
                                        style="font-weight: bold;">University or School Address</label></center>
                                <textarea type="text" class="form-control"
                                    placeholder="Jl. Siwalankerto No. 121-131, Surabaya, Indonesia" id="alamat_sekolah"
                                    name="alamat_sekolah" style="font-size: 12pt; text-align: center;" rows="2"
                                    required></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mx-3">
                        <h4 style="font-weight: bold; font-size: 18pt; color: red; text-align: center;">A T T E N T I O
                            N</h4>
                        <h4 style="font-size: 12pt; color: red; text-align: center;">For participant who <b>DOES NOT</b>
                            have a <b>Student ID (KTM or Student Card)</b>, <b>MISSING</b>, or has <b>EXCEEDED THE
                                VALIDITY PERIOD</b> of the Student ID, then you <b><u>MUST</u></b> make <b>A Statement
                                Letter</b> stating that you are currently studying at the University or School that you
                            are attending, and <b>SIGNED</b> by the Head of Study Program (for University) or other
                            parties for School (School Principal, School Administration, or Teacher).</h4>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <h3 style="font-weight: bold; font-size: 18pt; color: red; text-align: center;">Please Fill Your
                            Information</h3>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="Ex: petracivilexpo@gmail.com"
                                    style="height:40px; font-size: 12pt; text-align: center;" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="domisili" name="domisili"
                                    placeholder="Ex: Surabaya, Melbourne, Vancouver, etc."
                                    style="height:40px; font-size: 12pt; text-align: center;" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-6 offset-md-3">
                            <div class="form-group" align="center">
                                <label for="student_id" style="font-weight: bold;">Upload Your Student ID<br><span
                                        style="color: red;">(MAX 5 MB OF .jpg, .jpeg, OR .png)</span></label>
                                <input type="file" class="form-control-file fileUploadContainer" id="student_id"
                                    name="student_id" accept="image/*" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mx-3">
                        <h3 style="font-weight: bold; font-size: 12pt; color: red; text-align: center;" id="warning">
                            Please make sure all data is filled and correct before submitting!</h3>
                    </div>
                    ...
                    <center>
                        <button onclick="checkFill()"
                            style="border-radius: 5px; font-weight: bold; height:40px; font-size: 12pt;" type="submit"
                            class="btn btn-warning" id="submit">Submit Data</button>
                        <div id="uploading" hidden>
                            ...
                            <br>
                            <br>
                            <h3 style="color: red; font-size: 12pt; font-weight: bold;" id="uploading">Uploading...
                                Please wait.</h3>
                            <h3 style="color: red; font-size: 12pt; font-weight: bold;" id="uploading">Large file sizes
                                may took some time!</h3>
                        </div>
                    </center>
        ...
        <a id="back-to-top" href="#" class="btn btn-danger btn-lg back-to-top" role="button"><i
