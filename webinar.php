<?php
// header("Location: openrec/index.php");
?>
...
<body>
    <div class="container">
        <center><a href="http://pce.petra.ac.id/" target="_blank"><img src="assets/pce_logo monochrome.png" alt="" id="logo-pce"></a></center><br><br>
        <span class="text1">Under Maintenance</span>
        <span class="text2">Registration Petra Civil Expo 2021</span>
        <center style="margin-top:20px;">
            <a href="https://www.instagram.com/petracivilexpo/" target="_blank" style="font-size: 20pt; color: yellow; padding-left: 3px; text-decoration: none;">@petracivilexpo</a>
        </center>
    </div>
    <!-- <section>
