...
$_SESSION['page'] = 'jadwal_checking_bc';
...
<head>
    <title>Jadwal Checking Jembatan</title>
</head>
...
<script type="text/javascript">
    ...
    function show() {
        ...
        $.ajax({
            url: "phps/refresh_jadwal_checking_bc.php",
            type: "get",
            dataType: "json",
    ...
    <div class="container-fluid" style="color: #412c27; margin-top: 30px;">
        <div class="row">
            <div class="col-12 col-md-10 offset-md-1">
                <div align="center">
                    <h2>LIST JADWAL CHECKING JEMBATAN</h2>
        ...
        <div class="row">
            ...
            <!-- <div class="col-12 col-md-10 offset-md-1" style="padding-top: 30px;">
                <select class="form-control" id="filter_tanggal" name="filter_tanggal" style="height:40px; font-size: 12pt;">
                    ...
                    <option value="23-04-2021">23-04-2021</option>
                    <option value="24-04-2021">24-04-2021</option>
                </select>
            </div> -->
            <div class="col-12 col-md-10 offset-md-1" style="padding-top: 30px;">
                <select class="form-control" id="filter_jam" name="filter_jam" style="height:40px; font-size: 12pt;">
                    ...
                    <?php
                    $getJamsql = "SELECT DISTINCT jam FROM jadwal_checking_bc ORDER BY jam ASC";
                ...
                <table class="table table-hovered table-striped" id="pendaftarTable2" style="color: #412c27; width: 100%" hidden>
                    <thead style="text-align: center; font-weight: bold;">
                        <tr>
                            ...
                            <td>Tanggal Checking Jembatan</td>
                            <td>Jam Checking Jembatan</td>
                        </tr>
                    </thead>
