...
<body>
	<nav class="navbar navbar-expand-xl navbar-light" style="z-index: 10;">
		<a class="navbar-brand" href="http://pce.petra.ac.id/admin/home.php">
			<img src="..\assets\pce_logo color.png" style="width:100px; height:29px;" class="d-inline-block align-top" alt="" loading="lazy">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarToggler">
			<ul class="navbar-nav">
				...
				if ($_SESSION['page'] == 'webinar') {
					echo '<li class="nav-item active">
							<a class="nav-link" href="list_pendaftar_webinar.php"><i class="fas fa-microphone" style="padding-right: 4px;"></i> PENDAFTAR WEBINAR</a>
							</li>';
				} else {
					echo '<li class="nav-item">
							<a class="nav-link" href="list_pendaftar_webinar.php"><i class="fas fa-microphone" style="padding-right: 4px;"></i> PENDAFTAR WEBINAR</a>
				...
				?>
					<div class="dropdown">
						<a class="nav-link" href="" id="dropdownMenuButton" data-toggle="dropdown"><b>Bridge Competition</b></a>
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="text-align: center;">
							<a class="dropdown-item" href="list_balsa.php"><i class="fas fa-tree" style="padding-right: 4px;"></i> PENERIMA KAYU BALSA</a>
							<a class="dropdown-item" href="list_jadwal_checking_bc.php"><i class="fas fa-calendar-alt" style="padding-right: 4px;"></i> LIST JADWAL CHECKING</a>
						</div>
					</div>
				<?php
				} else {
				...
				?>
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="text-align: center;">
							<a class="dropdown-item" href="list_jadwal_checking_erdc.php"><i class="fas fa-calendar-alt" style="padding-right: 4px;"></i> LIST JADWAL CHECKING</a>
						</div>
					</div>
				<?php
				} else {
				...
				?>
				<li class="nav-item">
					<a class="nav-link" onclick="signOut()" style="cursor: pointer;"><i class="fa fa-sign-out" style="padding: 4px;"></i>SIGN OUT</a>
				</li>
			</ul>
		</div>
	</nav>