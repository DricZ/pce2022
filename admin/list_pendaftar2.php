...
<head>
    <title>List Pendaftar Lomba</title>
</head>
...
<script type="text/javascript">
    function updateStatus(data) {
        ...
        $.confirm({
                    ...
                    action: function() {
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                setTimeout(function() {
                                    window.location.href = "list_pendaftar2.php";
                                }, 3000);
                            }
                        });
                    }
            ...
            content: "<div style='color: black; font-size: 12pt;'>Apakah Anda yakin akan mengkonfirmasi validitas bukti pembayaran untuk nama team <b>" +
            ...
            onOpen: function() {
                setTimeout(() => {
                    ...
                    <div style='color: black; font-size: 12pt; max-height: 300px;'>
                        ...
                        <br>`;
                    if (bukti_bc != '') {
                        str += `<a type='button' onclick='displayBuktiBC(this)' data-bukti-bc='` +
                            bukti_bc +
                            `' class='btn btn-warning' style='-webkit-appearance: none;'>LIHAT BUKTI PEMBAYARAN<br><b>BRIDGE COMPETITION</b></a><br><br>`;
                    }
                    if (bukti_erdc != '') {
                        str +=
                            `<a type='button' onclick='displayBuktiERDC(this)' data-bukti-erdc='` +
                            bukti_erdc +
                            `' class='btn btn-warning' style='-webkit-appearance: none;'>LIHAT BUKTI PEMBAYARAN<br><b>EARTHQUAKE RESISTANT DESIGN COMPETITION</b></a><br><br>`;
                    }
                    if (bukti_lktb != '') {
                        str +=
                            `<a type='button' onclick='displayBuktiLKTB(this)' data-bukti-lktb='` +
                            bukti_lktb +
                            `' class='btn btn-warning' style='-webkit-appearance: none;'>LIHAT BUKTI PEMBAYARAN<br><b>LOMBA KUAT TEKAN BETON</b></a><br><br>`;
                    }
                    str += `
    ...
    function displayBuktiBC(data) {
        ...
        $.confirm({
            ...
            onOpen: function() {
                setTimeout(() => {
                    this.$content.html("<a href='../uploads/bukti_transfer_bc/" + bukti +
                        "' target='_blank'><img src='../uploads/bukti_transfer_bc/" + bukti +
    ...
    function displayBuktiERDC(data) {
        ...
        $.confirm({
            ...
            onOpen: function() {
                setTimeout(() => {
                    this.$content.html("<a href='../uploads/bukti_transfer_erdc/" + bukti +
                        "' target='_blank'><img src='../uploads/bukti_transfer_erdc/" + bukti +
                        "' style='max-width: 60%;'></a><p class='mt-3' style='color: red; font-weight: bold;'>(CLICK ON IMAGE TO ENLARGE)</p>")
                }, 100);
            },
            backgroundDismissAnimation: 'random',
    ...
    function displayBuktiLKTB(data) {
        ...
        $.confirm({
            ...
            onOpen: function() {
                setTimeout(() => {
                    this.$content.html("<a href='../uploads/bukti_transfer_lktb/" + bukti +
                        "' target='_blank'><img src='../uploads/bukti_transfer_lktb/" + bukti +
                        "' style='max-width: 60%;'></a><p class='mt-3' style='color: red; font-weight: bold;'>(CLICK ON IMAGE TO ENLARGE)</p>")
                }, 100);
            },
            backgroundDismissAnimation: 'random',
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    str += "</td>";
                    str += "<td><a type='button' style='-webkit-appearance: none;' class='btn btn-warning' href='viewberkas.php?id=" + d.id +
                        "'><b>View</b></a></td>";
                    str +=
                        '<td><button id="view_bukti" style="font-weight: bold; font-size: 12pt;" class="btn btn-success" data-sekolah="' +
                        d.nama_sekolah + '" data-nama="' + d.nama_kelompok + '" data-norek="' + d
                        .norek_pentransfer + '" data-namarek="' + d.nama_pentransfer + '" data-bukti-bc="' +
                        d.bukti_transfer_bc + '" data-bukti-erdc="' + d.bukti_transfer_erdc +
                        '" data-bukti-lktb="' + d.bukti_transfer_lktb +
                        '" onclick="viewBukti(this)">VIEW</button></td>';
                    if (d.status == 0) {
                        str +=
                            "<td><button id='confirm' style='font-size: 12pt;' class='btn btn-danger' data-sekolah='" +
                            d.nama_sekolah + "' data-nama='" + d.nama_kelompok + "' data-id='" + d.id +
                    ...
                    str2 += "<td>" + num + "</td>";
                    str2 += "<td>" + d.tanggal_daftar + "</td>";
                    str2 += "<td>" + d.nama_sekolah + "</td>";
                    str2 += "<td>" + d.nama_kelompok + "</td>";
                    str2 += "<td>" + d.jumlah_anggota + "</td>";
                    str2 += "<td>";
                    if (d.pilihan_lomba_1 != '') {
                        str2 += d.pilihan_lomba_1 + " ";
                    }
                    if (d.pilihan_lomba_2 != '') {
                        str2 += d.pilihan_lomba_2 + " ";
                    }
                    if (d.pilihan_lomba_3 != '') {
                        str2 += d.pilihan_lomba_3 + " ";
                    }
                    str2 += "</td>";
                    str2 += "<td>" + d.nama_peserta_1 + "</td>";
                    str2 += "<td>" + d.line_peserta_1 + "</td>";
                    str2 += "<td>" + d.email_peserta_1 + "</td>";
                    str2 += "<td>" + d.hp_peserta_1 + "</td>";
                    str2 += "<td>" + d.nama_peserta_2 + "</td>";
                    str2 += "<td>" + d.line_peserta_2 + "</td>";
                    str2 += "<td>" + d.email_peserta_2 + "</td>";
                    str2 += "<td>" + d.hp_peserta_2 + "</td>";
                    str2 += "<td>" + d.nama_peserta_3 + "</td>";
                    str2 += "<td>" + d.line_peserta_3 + "</td>";
                    str2 += "<td>" + d.email_peserta_3 + "</td>";
                    str2 += "<td>" + d.hp_peserta_3 + "</td>";
                    if (d.status == 0) {
                        str2 += "<td>KONFIRMASI</td>";
                    } else {
                        str2 += "<td>CONFIRMED BY<br><span style='font-weight: bold;'>" + d.confirmed_by +
                            "</span><br><i class='fas fa-check' style='color: green;'></i></td>";
                    }
                    str2 += "</tr>";
                    num = num + 1;
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered">
                            ...
                            <tbody style="text-align: center;">
                                <?php
                                $getPil1SMAsql = "SELECT pilihan_lomba_1, COUNT(*) as x FROM pendaftar WHERE pilihan_lomba_1 != '' AND jenjang_pendidikan = ?";
                                $getPil1SMAstmt = $pdo->prepare($getPil1SMAsql);
                                $getPil1SMAstmt->execute(['Senior High School']);
                                $getPil1SMA = $getPil1SMAstmt->fetch();

                                $getPil1Univsql = "SELECT pilihan_lomba_1, COUNT(*) as x FROM pendaftar WHERE pilihan_lomba_1 != '' AND jenjang_pendidikan = ?";
                                $getPil1Univstmt = $pdo->prepare($getPil1Univsql);
                                $getPil1Univstmt->execute(['College']);
                                $getPil1Univ = $getPil1Univstmt->fetch();
                                ...
                                echo '<tr><td>Bridge Competition (SMA)</td><td>' . $getPil1SMA['x'] . '</td></tr>';
                                echo '<tr><td>Bridge Competition (University)</td><td>' . $getPil1Univ['x'] . '</td></tr>';
                                echo '<tr><td>Earthquake Resistant Design Competition</td><td>' . $getPil2['x'] . '</td></tr>';
                        ...
                        echo '<br><p style="color: black; text-align: center;"><b>Jumlah total pendaftar</b></p><h3 style="color: black; text-align: center;"><b>&#129511; ' . $pendaftar["x"] . ' TEAM &#129511;</b></h3><br>';
                        ?>
                ...
                <table class="table table-hovered table-striped" id="pendaftarTable2" style="color: #412c27; width: 100%" hidden>
                    <thead style="text-align: center; font-weight: bold;">
                        <tr>
                            ...
                            <td>ID Line Peserta 1</td>
                            <td>Email Peserta 1</td>
                            <td>No HP Peserta 1</td>
                            <td>Nama Peserta 2</td>
                            <td>ID Line Peserta 2</td>
                            <td>Email Peserta 2</td>
                            <td>No HP Peserta 2</td>
                            <td>Nama Peserta 3</td>
                            <td>ID Line Peserta 3</td>
                            <td>Email Peserta 3</td>
                            <td>No HP Peserta 3</td>
