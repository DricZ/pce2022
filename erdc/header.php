        ...
        <nav>
            ...
            <div class="menu">
                <ul>
                    ...
                    ?>
                                <li><a href="../" style="color: black;">Petra Civil Expo 2022</a></li>
                                <li><a href="jadwal_checking_erdc.php" style="color: black;"><b>Pemilihan Jadwal</b></a></li>
                                <li><a href="info_checking.php" style="color: black;">Checking Session</a></li>
                                <li><a role="button" onclick="signOut()" style="color: black;"><i class="fas fa-sign-out-alt"></i> Sign Out</a></li>
                            <?php
                            }
                            if ($_SESSION['page'] == 'info_checking_erdc') {
                            ?>
                                <li><a href="../" style="color: black;">Petra Civil Expo 2022</a></li>
                                <li><a href="jadwal_checking_erdc.php" style="color: black;">Pemilihan Jadwal</a></li>
                                <li><a href="info_checking.php" style="color: black;"><b>Checking Session</b></a></li>
                                <li><a role="button" onclick="signOut()" style="color: black;"><i class="fas fa-sign-out-alt"></i> Sign Out</a></li>
                            <?php
                            }
                        } else {
                            ...
                            <li><a href="../" style="color: black;">Petra Civil Expo 2022</a></li>
                            <li><a href="info_checking.php" style="color: black;"><b>Checking Session</b></a></li>
                            <li><a role="button" href="./index.php" style="color: black;">Login</a></li>
                    <?php
                        }
                    }
                    ?>
